  ...
  return (
    <Card className="border-slate-200/80 shadow-sm overflow-hidden">
      <div className="px-5 py-4 border-b border-slate-100 flex items-center gap-2">
        ...
        <span className="ml-auto text-[11px] text-slate-400">este dispositivo</span>
      </div>
            ...
            {profiles.map((profile) => (
              ...
              >
                ...
                <button
                  ...
                  className="ml-1 h-6 w-6 rounded-full hover:bg-red-100 hover:text-red-600 text-slate-400 flex items-center justify-center transition-colors"
